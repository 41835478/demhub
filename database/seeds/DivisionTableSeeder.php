...
class DivisionTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('divisions')->insert([
        ...
        ['name' => 'Science, Research & Academia', 'slug' => 'academia', 'bg_color' => '1D73A3', 'welcome_message' => 'SCIENCE<font style="visibility:hidden">*</font>&<font style="visibility:hidden">*</font>ACADEMIA'],
