...
@section('content')
  <div class="row" style="padding-top:40px">
    ...
    <div class="col-md-12 text-center">
      <h2 class="blue-text" style="font-size:300%">ABOUT US</h2>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="col-sm-6 col-sm-offset-3">
        <h3 style="text-align:center">Jennifer Duke Holmes, Founder, President </h3>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="col-sm-8 col-sm-offset-4" style="text-align:left">
        <h3>Sean William Kondra, Co-Founder, Director of Operations</h3>
        <p>
