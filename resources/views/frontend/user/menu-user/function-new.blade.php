...
<nav id="user-function" class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-header">
		...
		<a href="{{URL::route('')}}">{!! HTML::image("/images/logo/logo-min-white.png", "DEMHUB logo", array('class' => 'img-responsive','style' => 'width:175px;padding-left:30px;padding-top:10px')) !!}
		</a>
	</div>
	...
	<div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <!-- @if(Request::URL::route() === URL::route('main-home'))
                    <li class="active">
                ...
                @endif -->
                @if(Request::URL::route() === URL::route('discover'))
                <li class="active">
                ...
                @endif
                @if(Request::URL::route() === URL::route('discussion'))
                <li class="active">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
		                @if(Request::URL::route() === URL::route('self_profile'))
		                    <li>
		                        <a href="{{URL::route('self_profile')}}">
