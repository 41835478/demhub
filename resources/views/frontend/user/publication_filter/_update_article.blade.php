        ...
        @foreach ($publications as $publication)
          <div class="publication-each">
            <div class="publication-left">
              <ul>
                  <li class= "pub-date">{{ date_format(new DateTime($publication->publish_date), 'j F Y | g:i a') }}
            ...
            <div class="publication-right">
              <ul>
                ...
                <li class="pub-control">
                  <ul class="icon-container">
                    <li><a href="{{ $publication->document->url() }}" download style="padding-left:5px"
                  data-toggle="tooltip" data-placement="top" title="DOWNLOAD">
                  <h4 class="icon file_download"></h4></a></li>
                   <li><a><h4 class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="top" title="PREVIEW"></h4></a></li>
                   <li><a><h5 class="icon report2" data-toggle="tooltip" data-placement="top" title="REPORT"></h5></a></li>
                </li>
              </ul>
                <li>
                  <ul class="icon-container" style="margin:-4px auto auto -4px;">
