      ...
      <div class="row center-block mt10" style="margin-left:-75px">
        ...
        @if($publication->medias()->count() > 0 && $publication->medias()->first()->resource)
          <div class="col-sm-offset-5" style="display:inline">
            <a type="button" class="btn btn-style-alt" href="{{ $publication->medias()->first()->resource->url() }}">FULL SCREEN</a>
          </div>
        @endif
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            @if($publication->medias()->count() > 0 && $publication->medias()->first()->resource)
              <embed class="img-responsive" src="{{ $publication->medias()->first()->resource->url() }}" style="width:100%;height:500px;max-width:600px;max-height:1000px;"></embed>
            @endif
          </div>
