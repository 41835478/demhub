					...
					<li class="col-xs-8 nav-top-adjust" style="">
						...
						<div class="form-group" style="padding-left:15%;">
							<div class="input-group searchbar-group" style="width: 100%">
								<select class="input-group-addon nav-search-text animate" name="scope" style="float: left;width: 20%;padding: 9px;height:34px;">
								...
								<button type="submit" class="input-group-addon nav-search-icon-style animate" style="width: 10%;padding: 9.5px;height: 34px;margin-left:-2px;">
