...
@endif
    ...
    <div class="btn-group">
        ...
        <a type="button" class="btn btn-greytone btn-sm" style="margin-left:5px;" <?php echo ($item['subclass']=='thread') ? 'href="'.$item['url'].'"' : 'aria-haspopup="true" aria-expanded="false" data-toggle="dropdown"' ?>>
