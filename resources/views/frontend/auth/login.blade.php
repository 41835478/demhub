...
@section('content')
  ...
  <div id="welcome_sign-up" class="row"     style="padding:0px;background:url('http://localhost/images/backgrounds/dried_earth.jpg')  no-repeat fixed center;
    ...
    <div class="row" style="padding-top:50px;">
      <div class="col-md-12 text-center">
        <h2 style="font-size:300%">{{trans('labels.login_box_title')}}</h2>
      </div>
    </div>
