     ...
     @if(Auth::user())
       ...
       <ul class="dropdown-menu">
         <li><a class="article_twitter" href="https://twitter.com/share" data-hashtags="DEMHUBnetwork" data-text="{{$item['name']}}"
          data-url="<?php if($item['subclass']!=='article' && $item['subclass']!=='publication'){ echo url('').'/';}; echo $item['url']; ?>">TWEET</a> </li>
         ...
         <li><a><span>
           <?php if($item['subclass']!=='article' && $item['subclass']!=='publication'){ echo substr(url(''),7).'/';}; echo $item['url']; ?>
         </span></a></li>
