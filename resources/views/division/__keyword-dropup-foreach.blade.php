@foreach($keywords as $index=>$keyword)
  ...
  <div class="arrows" style="display:inline-block;margin-left:-45px;"><i class="" ></i></div>

  @elseif($index==2)
  {{-- Creates a keyword dropup menu  AND adds second keyword to the dropup--}}
  <div class="dropup" style="display:inline;margin-left:-45px">
    ...
    <div class="arrows" style="display:inline-block;margin-left:-45px;"><i class="triangle-right" ></i></div>
