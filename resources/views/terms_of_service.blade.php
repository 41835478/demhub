...
<p>
		Please note that if you are accessing any DEMHUB service in your capacity as a government entity, there are special terms that may apply to you. Please see Section G.17, below, for more details.
</p>
<p>
...
<p>
	...
	5. You are responsible for maintaining the security of your account and password. DEMHUB cannot and will not be liable for any loss or damage from your failure to comply with this security obligation.
...
<p>
		...
		DEMHUB does not pre-screen Content, but DEMHUB and its designee have the right (but not the obligation) in their sole discretion to refuse or remove any Content that is available via the Service.

		You shall defend DEMHUB against any claim, demand, suit or proceeding made or brought against DEMHUB by a third-party alleging that Your Content, or Your use of the Service in violation of this Agreement, infringes or misappropriates the intellectual property rights of a third-party or violates applicable law, and shall indemnify DEMHUB for any damages finally awarded against, and for reasonable attorney’s fees incurred by, DEMHUB in connection with any such claim, demand, suit or proceeding; provided, that DEMHUB (a) promptly gives You written notice of the claim, demand, suit or proceeding; (b) gives You sole control of the defense and settlement of the claim, demand, suit or proceeding (provided that You may not settle any claim, demand, suit or proceeding unless the settlement unconditionally releases DEMHUB of all liability); and (c) provides to You all reasonable assistance, at Your expense.
...
<p>
	...
	Support for DEMHUB services is only available in English, via email.

	You understand that DEMHUB uses third-party vendors and hosting partners to provide the necessary hardware, software, networking, storage, and related technology required to run the Service.

	You must not modify, adapt or hack the Service or modify another website so as to falsely imply that it is associated with the Service, DEMHUB, or any other DEMHUB service.

	You may use the DEMHUB Pages static hosting service solely as permitted and intended to host your organization pages, personal pages, or project pages, and for no other purpose. You may not use DEMHUB Pages in violation of DEMHUB's trademark or other rights or in violation of applicable law. DEMHUB reserves the right at all times to reclaim any DEMHUB subdomain without liability to you.

	You agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of the Service, use of the Service, or access to the Service without the express written permission by DEMHUB.
...
<p>
		If your bandwidth usage significantly exceeds the average bandwidth usage (as determined solely by DEMHUB) of other DEMHUB customers, we reserve the right to immediately disable your account or throttle your file hosting until you can reduce your bandwidth consumption.

		DEMHUB does not warrant that (i) the service will meet your specific requirements, (ii) the service will be uninterrupted, timely, secure, or error-free, (iii) the results that may be obtained from the use of the service will be accurate or reliable, (iv) the quality of any products, services, information, or other material purchased or obtained by you through the service will meet your expectations, and (v) any errors in the Service will be corrected.
...
<p>
		Questions about the Terms of Service should be sent to info@demhub.ca.

		If you are a government user or otherwise accessing or using any DEMHUB service in a government capacity, this Amendment to DEMHUB Terms of Service shall apply to you.
