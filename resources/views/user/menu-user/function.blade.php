...
<div class="row">
	...
	<div class="navbar navbar-default" role="navigation" style="padding-left:4.7%">
				...
				<li><a href="{url('logout')}}"><!-- <img src="css/hot-potato-black-text-with-logo.png" class="blackImage" alt="Hot Potato" width="101.48" height="22" style="padding-bottom:0px;"><img src="css/hot-potato-white-text-with-logo.png" class="whiteImage" alt="Hot Potato" width="101.48" height="22" style="padding-bottom:0px;"> --> NEWS FEED</a></li>

				<li><a href="{url('resource-filter')}}"><!-- <img src="css/find-video-black-resize.png" class="blackImage" alt="Hot Potato" width="35.24" height="23.5" style="padding-top:1px"><img src="css/find-video-white-resize.png" class="whiteImage" alt="Hot Potato" width="35.24" height="23.5" style="padding-top:1px"> --> RESOURCES</a></li>

  	            <li><a href="{url('logout')}}"><!-- <img src="css/cut-video-image-black.png" class="blackImage" alt="Hot Potato" width="35.24" height="23.5" style="padding-top:2px"><img src="css/cut-video-image-white.png" class="whiteImage" alt="Hot Potato" width="35.24" height="23.5" style="padding-top:2px"> --> EVENTS</a></li>
  				...
  				<li><a href="{url('logout')}}">MEDIA</a></li>
