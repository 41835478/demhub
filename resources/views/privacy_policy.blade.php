...
<div class="row" style="padding-top:40px">
	...
	<p>
		This privacy policy is designed to inform users of the DEMHUB website (the “Website”) about how we gather and use personal information collected by us in connection with use of the Website.  We will take reasonable steps to protect user privacy consistent with the guidelines set forth in this policy and with applicable U.S. laws.  In this policy, “user” or “you” means any person using the Website, whether by browsing the Website, creating a profile, submitting comments, blog entries or other content (“Content”), registering with us by creating a profile, or participating in any other activities available through the Website.  BY ACCESSING OR USING THE WEBSITE, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTAND, AND AGREE TO BE BOUND BY THIS PRIVACY POLICY AND OUR WEBSITE TERMS AND CONDITIONS.  IF YOU DO NOT AGREE TO THESE TERMS, DO NOT USE THE WEBSITE.
</p>
<h3 class="blue-text">
		What Information Do We Collect?
</h3>
<p>
		Personal Information:  We collect the following personal information in connection with the Website:  (a) when you sign up to create a DEMHUB profile, we collect the personal information you disclose on the account registration form and your profile, including your email address, password, contact information, first name, last name, gender, birthday, branch of service, rank, military specialty, current unit and duty station, professional experience, educational background, and any other information you provide at registration or in your profile; (b) if you communicate with us by email, we will collect your email address; (c) when you visit the Website, our servers will automatically recognize your IP address; and (d) if you submit Content, you may, at your option, include information (such as your name or photograph) in the Content that can be used to identify you.  All of this information is referred to in this Policy as “Personal Information”.

		Web Tracking Information: We, and our third party service providers, may use web tracking technologies such as cookies, web beacons, pixel tags and clear GIFs in order to operate the Website efficiently and to collect data related to usage of the Website and to web and email marketing conducted by us or on our behalf.  Such collected data (“Web Tracking Information”) may include the address of the websites you visited before and after you visited the Website, the type of browser you are using, your Internet Protocol (IP) address, what pages in the Website you visit and what links you clicked on, and whether you opened email communications we send to you.  In order to collect Web Tracking Information and to make your use of the Website more efficient, we may store cookies on your computer.  In addition, the third party ad networks (“Ad Networks”) that we use to display advertising to you may also store their own cookies on your computer.  We may also use web tracking technologies that are placed in web pages on the Website or in email communications to collect information about actions that users take when they interact with the Website or such email communications, and Ad Networks and DEMHUB’s Contractors (as hereinafter defined) may also do so.  We do not correlate Web Tracking Information to individual user Personal Information.  Some Web Tracking Information may include data, such as IP address data and general segment information (e.g., your unit, career field, or information about your professional or educational background, that is unique to you.  You may be able to modify your browser settings to alter which web tracking technologies are permitted when you use the Website, but this may affect the performance of the Website.
</p>
	<h3 class="blue-text">
		How Do We Use the Information We Collect?
</h3>
<p>
		We collect information when you sync non-DEMHUB content – like your email address book or mobile device contacts – with your account. We use this information to improve your experience, help connect you with military or veterans organizations which we have vetted and which we believe to have the best interest of the member in mind, and allow you and your network to be better connected. You can remove your address book and any other synced information whenever you'd like.

		You may use the DEMHUB contacts importer (or other similar mechanisms provided by DEMHUB) to upload individual contacts or your entire address book into DEMHUB. DEMHUB stores this information and uses it to help you manage and leverage your contacts. We also use this information to enhance your DEMHUB experience by helping you to grow your network by: identifying your contacts already on DEMHUB; informing your contacts that you are building your DEMHUB network; providing a template to send invitations to your contacts that have not registered with DEMHUB; and suggesting people you may know but who may not be in your DEMHUB contacts. DEMHUB may also use this information to show you and other members that you share the same uploaded contacts who may or may not be members. Please note that when you send an invitation to connect to another individual (a “connection”), that person may have access to your email address or, for SMS invitations, mobile number because it may be displayed in the invitation. DEMHUB may also remind you of pending invitations. Your DEMHUB connections may also have access to your email address.

		DEMHUB may make other tools available to sync information with DEMHUB, and may also develop additional features that allow members to use their DEMHUB account in conjunction with other third-party services. For example, DEMHUB mobile applications may allow you to sync your device’s calendar, email and/or contacts apps with DEMHUB.

		Another example are software tools that allow you to see DEMHUB and other public social media information about the people you email or meet with and leverage DEMHUB to help you gain insights from and grow your network. If you grant these products (mobile applications or other DEMHUB services that sync external email and calendar services permission to access your email and calendar accounts, they will access and may store some of your email header and calendar history information in order to match it to DEMHUB and other public social media profiles. DEMHUB’s products that sync with external email services may also temporarily cache message content for performance reasons, in a way that is unreadable by DEMHUB and its service providers.

		Any information that you upload or sync with DEMHUB is covered by the User Agreement and this Privacy Policy. You can remove your information at your convenience using the features DEMHUB makes available. You can remove your address book and any other synced information at any time by requesting this.

		Personal Information:  We will use and store Personal Information for the purpose of delivering the Website to you, and to enhance and analyze the operation of the Website.  DEMHUB uses Personal Information to provide better, more customized services such as visibility into career opportunities, allowing professional opportunities to find you, or for serving more relevant advertisements on DEMHUB.  We may also use Personal Information for the internal operational and administrative purposes of the Website.
...
<p>
		...
		DEMHUB Profile Privacy Settings:  You may choose which DEMHUB users can view your profile through your DEMHUB privacy settings.  You may choose to make your profile private so that it can only be seen by you.  If you set your profile as private, other DEMHUB users may not view your profile but your profile will be available to potential employers with access to DEMHUB.
...
<p>
		We disclose Personal Information to certain third party marketing firms, who may use your Personal Information for direct marketing purposes.  California law requires that you may request from us, not more than once per year, the following information: (a) a list of the categories of Personal Information that we disclosed to third parties for their direct marketing purposes during the immediately preceding calendar year; and (b) the names and addresses of all third parties that received Personal Information from us in the preceding calendar year for direct marketing purposes, and examples of the products or Websites marketed by such third parties, if known.  You may submit requests for such information to us by email to info@demhub.ca.  If you do not want us to disclose your Personal Information for direct marketing purposes, you may notify us of that choice at any time.
</p>
<h3 class="blue-text">
		Privacy Settings/Opt Out
</h3>
<p>
		If you would like to close your DEMHUB account or opt-out of email updates, please visit your DEMHUB settings page where you can control all your privacy settings or close your account. If you close your account, your data will no longer be displayed on the DEMHUB network and other DEMHUB members will not be able to find you.  Your removal will not remove records of past transactions or delete information stored in our data backups and archives.  Data on past transactions and data stored in backups and archives will be maintained and/or deleted in the ordinary course of DEMHUB’s business.
</p>
<h3 class="blue-text">
