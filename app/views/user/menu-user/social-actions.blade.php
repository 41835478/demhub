...
<div class="col-md-12 text-center" >
	<ul id="social" class="list-inline">
		<li class="like">
			...
			<a style="color:#{{$feed->getcategory->bg_color}}" href="{{URL::route('like', array('id' => $feed->id))}}">
		...
		<li class="dislike">
			<a style="color:#{{$feed->getcategory->bg_color}}" href="{{URL::route('dislike', array('id' => $feed->id))}}">
