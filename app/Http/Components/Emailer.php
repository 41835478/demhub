...
class Emailer
{
    ...
    public static function sendReengageEmail(User $user) {
		$email_images_path =  public_path().'/images/emails/reengageEmail/';
		try {
			$template_name = 're-engage-existing-users';
			$template_content = array( // required for some reason
					array(
							'name' => 'example name',
							'content' => 'example content'
    ...
    public static function sendPotentialUsersInvites($data) {
		$email_images_path =  public_path().'/images/emails/potential-users-invitation/';
		try {
			$template_name = 'potential-users-invitation';
			$template_content = array( // required for some reason
					array(
							'name' => 'example name',
							'content' => 'example content'
